            ...
            {visibleImages < galleryImages.length && (
                <div className='pt-[15px] flex justify-center'>
                    <button 
                        ...
                        Load More <svg xmlns="http://www.w3.org/2000/svg" width="22" height="14" viewBox="0 0 22 14" fill="none">
                            <path d="M21.1984 6.81641C18.2713 6.81641 15.8984 9.78252 15.8984 13.4414" stroke="white"/>
                            <path d="M0 6.81641H21.2" stroke="white"/>
                            <path d="M15.8984 0.191406C15.8984 3.85028 18.2713 6.81635 21.1984 6.81641" stroke="white"/>
                            </svg>
                    </button>
                </div>
            )}
