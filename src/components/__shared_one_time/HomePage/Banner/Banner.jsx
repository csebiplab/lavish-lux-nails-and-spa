  ...
  return (
    <div>
      ...
      <div className="hidden xl:block">
        <div className="large_banner_bg w-full lg:h-[500px] xl:h-[550px] 2xl:h-[600px] 3xl:h-[650px] 4xl:h-[700px] 5xl:h-[750px]">
          <div className="relative container h-full flex justify-center items-center">
            <Image
              ...
              width={1350}
              height={637}
              className="md:w-[1110px] lg:w-[1150px] xl:w-[1190px] 2xl:w-[1230px] 3xl:w-[1270px] 4xl:w-[1310px] 5xl:w-[1350px] h-[430] lg:h-[440px] xl:h-[450px] 2xl:h-[560px] 3xl:h-[580px] 4xl:h-[610px] 5xl:h-[630px]"
            />
            <div className="absolute md:top-[90px] lg:top-[100px] xl:top-[120px] 2xl:top-[135px] 3xl:top-[150px] 4xl:top-[170px] 5xl:top-[190px] md:left-[220px] lg:left-[250px] xl:left-[270px] 2xl:left-[310px] 3xl:left-[350px] 4xl:left-[400px] 5xl:left-[450px]">
              <h1 className="font-family-secondary text-left md:text-[45px] lg:text-[50px]  xl:text-[55px] 2xl:text-[60px] 3xl:text-[65px] 4xl:text-[70px] 5xl:text-[75px] font-normal leading-tight text-primary">
