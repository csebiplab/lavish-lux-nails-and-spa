        ...
        <div className="large_banner_bg w-full lg:h-[500px] xl:h-[520px] 2xl:h-[600px] 3xl:h-[650px] 4xl:h-[700px] 5xl:h-[840px]">
          <div className="relative container h-full flex justify-center items-center">
            <Image
              ...
              width={1350}
              height={637}
              className="md:w-[1110px] lg:w-[1150px] xl:w-[890px] 2xl:w-[1230px] 3xl:w-[1270px] 4xl:w-[1310px] 5xl:w-[1350px] h-[430] lg:h-[440px] xl:h-[400px] 2xl:h-[560px] 3xl:h-[580px] 4xl:h-[610px] 5xl:h-[555px]"
            />
            <div className="absolute md:top-[90px] lg:top-[100px] xl:top-[150px] 2xl:top-[135px] 3xl:top-[150px] 4xl:top-[170px] 5xl:top-[190px] md:left-[220px] lg:left-[250px] xl:left-[330px] 2xl:left-[310px] 3xl:left-[350px] 4xl:left-[400px] 5xl:left-[450px]">
